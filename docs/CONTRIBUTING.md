...
Ready to contribute? Here's how to set up `scenario_assessment` for local development.

1. Download a copy of `scenario_assessment` locally.
2. Install `scenario_assessment` using `poetry`:
